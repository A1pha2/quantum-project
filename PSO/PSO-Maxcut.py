...
base_history_dir = os.path.join(
    "..", "history", "PSO", "maxcut", "Brock200_2", "MT19937"
)
...
base_history_dir = os.path.join(
    "..", "history", "PSO", "maxcut", "Brock200_2", "QuasiRandom"
)
...
base_history_dir = os.path.join("..", "history", "PSO", "maxcut", "Brock200_2", "IBM")
...
base_history_dir = os.path.join(
    "..", "history", "PSO", "maxcut", "Brock200_2", "BeamSplitter"
)
...
base_history_dir = os.path.join(
    "..", "history", "PSO", "maxcut", "Brock200_4", "MT19937"
)
...
base_history_dir = os.path.join(
    "..", "history", "PSO", "maxcut", "Brock200_4", "QuasiRandom"
)
...
base_history_dir = os.path.join("..", "history", "PSO", "maxcut", "Brock200_4", "IBM")
...
base_history_dir = os.path.join(
    "..", "history", "PSO", "maxcut", "Brock200_4", "BeamSplitter"
)
...
base_history_dir = os.path.join("..", "history", "PSO", "maxcut", "C125.9", "MT19937")
...
base_starting_solution_dir = os.path.join("..", "starting_solution", "Maxcut", "C125.9")
base_history_dir = os.path.join(
    "..", "history", "PSO", "maxcut", "C125.9", "QuasiRandom"
)
...
# Base directories
base_starting_solution_dir = os.path.join("..", "starting_solution", "Maxcut", "C125.9")
base_history_dir = os.path.join("..", "history", "PSO", "maxcut", "C125.9", "IBM")
...
base_starting_solution_dir = os.path.join("..", "starting_solution", "Maxcut", "C125.9")
base_history_dir = os.path.join(
    "..", "history", "PSO", "maxcut", "C125.9", "BeamSplitter"
)
...
filePath2 = os.path.join("..", "maxcut_problem", "gen200_p0.9_44.b.txt")
edges = load_maxcut_file(filePath2)
...
base_history_dir = os.path.join(
    "..", "history", "PSO", "maxcut", "gen200_p0.9_44.b", "MT19937"
)
...
base_history_dir = os.path.join(
    "..", "history", "PSO", "maxcut", "gen200_p0.9_44.b", "QuasiRandom"
)
...
base_history_dir = os.path.join(
    "..", "history", "PSO", "maxcut", "gen200_p0.9_44.b", "IBM"
)
...
base_history_dir = os.path.join(
    "..", "history", "PSO", "maxcut", "gen200_p0.9_44.b", "BeamSplitter"
)
...
filePath2 = os.path.join("..", "maxcut_problem", "keller4.txt")
edges = load_maxcut_file(filePath2)
...
base_history_dir = os.path.join("..", "history", "PSO", "maxcut", "Keller4", "MT19937")
...
base_history_dir = os.path.join(
    "..", "history", "PSO", "maxcut", "Keller4", "QuasiRandom"
)
...
base_history_dir = os.path.join("..", "history", "PSO", "maxcut", "Keller4", "IBM")
...
base_history_dir = os.path.join(
    "..", "history", "PSO", "maxcut", "Keller4", "BeamSplitter"
)
