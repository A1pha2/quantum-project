...
os.chdir("D:/quantum-project/ga") # Change the current working directory
import sys
...
base_history_dir = os.path.join(
    "..", "history", "ga", "maxcut", "Brock200_2", "MT19937"
)
...
base_history_dir = os.path.join(
    "..", "history", "ga", "maxcut", "Brock200_2", "QuasiRandom"
)
...
base_history_dir = os.path.join(
    "..", "history", "ga", "maxcut", "Brock200_2", "BeamSplitter"
)
...
base_history_dir = os.path.join(
    "..", "history", "ga", "maxcut", "Brock200_4", "MT19937"
)
...
base_history_dir = os.path.join(
    "..", "history", "ga", "maxcut", "Brock200_4", "QuasiRandom"
)
...
base_history_dir = os.path.join(
    "..", "history", "ga", "maxcut", "Brock200_4", "BeamSplitter"
)
...
base_starting_solution_dir = os.path.join("..", "starting_solution", "Maxcut", "C125.9")
base_history_dir = os.path.join(
    "..", "history", "ga", "maxcut", "C125.9", "QuasiRandom"
)
...
base_starting_solution_dir = os.path.join("..", "starting_solution", "Maxcut", "C125.9")
base_history_dir = os.path.join(
    "..", "history", "ga", "maxcut", "C125.9", "BeamSplitter"
)
...
base_history_dir = os.path.join(
    "..", "history", "ga", "maxcut", "gen200_p0.9_44.b", "MT19937"
)
...
base_history_dir = os.path.join(
    "..", "history", "ga", "maxcut", "gen200_p0.9_44.b", "QuasiRandom"
)
...
base_history_dir = os.path.join(
    "..", "history", "ga", "maxcut", "gen200_p0.9_44.b", "IBM"
)
...
base_history_dir = os.path.join(
    "..", "history", "ga", "maxcut", "gen200_p0.9_44.b", "BeamSplitter"
)
...
base_history_dir = os.path.join(
    "..", "history", "ga", "maxcut", "Keller4", "QuasiRandom"
)
...
base_history_dir = os.path.join(
    "..", "history", "ga", "maxcut", "Keller4", "BeamSplitter"
)
